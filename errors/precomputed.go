...
func BadRequest(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusBadRequest).WithKind(kind)
}
...
func Unauthorized(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusUnauthorized).WithKind(kind)
}
...
func MethodNotAllowed(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusMethodNotAllowed).WithKind(kind)
}
...
func NotAcceptable(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusNotAcceptable).WithKind(kind)
}
...
func ProxyAuthRequired(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusProxyAuthRequired).WithKind(kind)
}
...
func LengthRequired(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusLengthRequired).WithKind(kind)
}
...
func PreconditionFailed(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusPreconditionFailed).WithKind(kind)
}
...
func RequestEntityTooLarge(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusRequestEntityTooLarge).WithKind(kind)
}
...
func RequestURITooLong(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusRequestURITooLong).WithKind(kind)
}
...
func UnsupportedMediaType(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusUnsupportedMediaType).WithKind(kind)
}
...
func RequestedRangeNotSatisfiable(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusRequestedRangeNotSatisfiable).WithKind(kind)
}
...
func ExpectationFailed(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusExpectationFailed).WithKind(kind)
}

// Teapot return an error with status code http.StatusTeapot
func Teapot(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusTeapot).WithKind(kind)
}
...
func MisdirectedRequest(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusMisdirectedRequest).WithKind(kind)
}
...
func UnprocessableEntity(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusUnprocessableEntity).WithKind(kind)
}

// Locked return an error with status code http.StatusLocked
func Locked(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusLocked).WithKind(kind)
}
...
func FailedDependency(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusFailedDependency).WithKind(kind)
}

// TooEarly return an error with status code http.StatusTooEarly
func TooEarly(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusTooEarly).WithKind(kind)
}
...
func UpgradeRequired(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusUpgradeRequired).WithKind(kind)
}
...
func PreconditionRequired(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusPreconditionRequired).WithKind(kind)
}
...
func TooManyRequests(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusTooManyRequests).WithKind(kind)
}
...
func RequestHeaderFieldsTooLarge(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusRequestHeaderFieldsTooLarge).WithKind(kind)
}
...
func UnavailableForLegalReasons(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusUnavailableForLegalReasons).WithKind(kind)
}
...
func InternalServerError(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusInternalServerError).WithKind(kind)
}
...
func NotImplemented(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusNotImplemented).WithKind(kind)
}
...
func BadGateway(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusBadGateway).WithKind(kind)
}
...
func ServiceUnavailable(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusServiceUnavailable).WithKind(kind)
}
...
func GatewayTimeout(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusGatewayTimeout).WithKind(kind)
}
...
func HTTPVersionNotSupported(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusHTTPVersionNotSupported).WithKind(kind)
}
...
func VariantAlsoNegotiates(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusVariantAlsoNegotiates).WithKind(kind)
}
...
func InsufficientStorage(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusInsufficientStorage).WithKind(kind)
}
...
func LoopDetected(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusLoopDetected).WithKind(kind)
}
...
func NotExtended(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusNotExtended).WithKind(kind)
}
...
func NetworkAuthenticationRequired(kind, msgFormat string, args ...interface{}) Error {
	return ErrF(msgFormat, args...).WithStatus(http.StatusNetworkAuthenticationRequired).WithKind(kind)
}
