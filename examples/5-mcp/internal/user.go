...
// Validate is an implementation of middleware.BodyValidation.
...
var users = []User{
	{ID: 1, UserBody: UserBody{Name: "John Smith"}},
	{ID: 2, UserBody: UserBody{Name: "Bridget Jones"}},
	{ID: 3, UserBody: UserBody{Name: "Juliet Quinn"}},
	{ID: 4, UserBody: UserBody{Name: "Frank Davis"}},
}
